...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.findAnchor = function(target) {
      var a, anchor, error, s, strategies, _k, _len2;
      if (target == null) {
        ...
        try {
          ...
          if (anchor != null) {
            ...
            if (this.twoPhaseAnchoring) {
              ...
              for (pageIndex = _l = _ref3 = vAnchor.startPage, _ref4 = vAnchor.endPage; _ref3 <= _ref4 ? _l <= _ref4 : _l >= _ref4; pageIndex = _ref3 <= _ref4 ? ++_l : --_l) {
              ...
              setTimeout(function() {
                return _this._physicallyAnchor(anchor);
              });
            } else {
    ...
    Annotator.prototype.deleteAnnotation = function(annotation) {
      var a, child, h, _k, _l, _len2, _len3, _ref1, _ref2;
    ...
    Annotator.prototype._removeAnchor = function(anchor) {
      ...
      for (index = _k = _ref1 = anchor.virtual.startPage, _ref2 = anchor.virtual.endPage; _ref1 <= _ref2 ? _k <= _ref2 : _k >= _ref2; index = _ref1 <= _ref2 ? ++_k : --_k) {
        if (this.anchors[index] != null) {
          ...
          _results.push(console.log("Warning: in _removeAnchor, we have no anchors for page #" + index + ", even though it should be related."));
        }
      }
      return _results;
    };
    ...
    Annotator.prototype._physicallyAnchor = function(anchor) {
      ...
      return this._physicallyAnchorText(anchor);
    };

    Annotator.prototype._physicallyAnchorText = function(anchor) {
    ...
    Annotator.prototype._physicallyUnAnchor = function(anchor, index) {
      var ann, data, hl, i, _k, _len2, _ref1, _ref2, _ref3;
