  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.getTargetFromRange = function(range) {
      ...
      if (this.pdfMode) {
        ...
        selectors = [this.getRangeSelector(range), this.getTextQuoteSelector(range), this.getTextPositionSelector(range)];
      }
      return {
        source: this.getHref(),
        selector: selectors
