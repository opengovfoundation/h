...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.deleteAnnotation = function(annotation) {
      var child, h, t, _k, _l, _len2, _len3, _ref1, _ref2;
      _ref1 = annotation.target;
      for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
        t = _ref1[_k];
        if (t.virtualAnchor != null) {
          this._removeVirtualAnchor(t.virtualAnchor.task);
        }
      }
    ...
    Annotator.prototype._addVirtualAnchor = function(task) {
      var anchor, mapped, pageIndex, _base, _k, _ref1, _ref2,
        _this = this;
      ...
      for (pageIndex = _k = _ref1 = anchor.startPage, _ref2 = anchor.endPage; _ref1 <= _ref2 ? _k <= _ref2 : _k >= _ref2; pageIndex = _ref1 <= _ref2 ? ++_k : --_k) {
        ...
        if (this.domMapper.isPageMapped(pageIndex)) {
          mapped = true;
        }
      }
      if (mapped) {
    ...
    Annotator.prototype._removeVirtualAnchor = function(task) {
      var anchor, i, pageIndex, tasks, _k, _ref1, _ref2, _ref3;
      anchor = task.target.virtualAnchor;
      for (pageIndex = _k = _ref1 = anchor.startPage, _ref2 = anchor.endPage; _ref1 <= _ref2 ? _k <= _ref2 : _k >= _ref2; pageIndex = _ref1 <= _ref2 ? ++_k : --_k) {
        tasks = this.virtualAnchors[pageIndex];
        i = tasks.indexOf(task);
        [].splice.apply(tasks, [i, i - i + 1].concat(_ref3 = [])), _ref3;
      }
      return delete anchor.task;
    };

    Annotator.prototype._physicallyAnchorAnnotation = function(task) {
      var browserRanges, highlights, mappings, pAnchor, r, ranges, s, serializedRanges, vAnchor, _ref1;
      pAnchor = task.target.physicalAnchor;
      if (pAnchor != null) {
        if (pAnchor.allRendered) {
          return;
        }
      } else {
      ...
      mappings = this.domMapper.getMappingsForCharRange(vAnchor.start, vAnchor.end, pAnchor.pages);
      browserRanges = (function() {
        var _k, _len2, _ref1, _results;
        _ref1 = mappings.sections;
        _results = [];
      ...
      serializedRanges = (function() {
        var _k, _len2, _results;
        _results = [];
        for (_k = 0, _len2 = ranges.length; _k < _len2; _k++) {
          r = ranges[_k];
          _results.push(r.serialize(this.wrapper[0], '.annotator-hl'));
        }
        return _results;
      }).call(this);
      $.merge(task.annotation.ranges, serializedRanges);
      $.merge(pAnchor.ranges, serializedRanges);
      highlights = (_ref1 = []).concat.apply(_ref1, (function() {
        var _k, _len2, _results;
        _results = [];
        for (_k = 0, _len2 = ranges.length; _k < _len2; _k++) {
          r = ranges[_k];
          _results.push(this.highlightRange(r));
        }
        return _results;
      }).call(this));
    ...
    Annotator.prototype._physicallyAnchorPage = function(index) {
      ...
      if (!((tasks != null) && this.domMapper.isPageMapped(index))) {
        return;
      }
      _results = [];
    ...
    Annotator.prototype._physicallyUnAnchorAnnotation = function(task) {
      var anchor, hl, i, r, _k, _l, _len2, _len3, _ref1, _ref2, _ref3, _ref4;
      ...
      for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
        ...
        [].splice.apply(task.annotation.ranges, [i, i - i + 1].concat(_ref2 = [])), _ref2;
      }
      _ref3 = anchor.highlights;
      for (_l = 0, _len3 = _ref3.length; _l < _len3; _l++) {
        hl = _ref3[_l];
        i = task.annotation.highlights.indexOf(hl);
        [].splice.apply(task.annotation.highlights, [i, i - i + 1].concat(_ref4 = [])), _ref4;
      }
