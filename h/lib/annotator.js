...
(function() {
  ...
  Annotator = (function(_super) {
      ...
      strategies = [
        {
          ...
          init: function() {
            return _this.domMapper.onPageReady = function(index) {
    ...
    Annotator.prototype.findAnchor = function(target) {
      ...
      strategies = [this.findAnchorWithTwoPhaseFuzzyMatching, this.findAnchorWithFuzzyMatching];
      error = null;
      anchor = null;
      for (_k = 0, _len2 = strategies.length; _k < _len2; _k++) {
        fn = strategies[_k];
