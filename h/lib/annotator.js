  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype._setupMatching = function() {
      ...
      if (this.pdfMode) {
        ...
        this.pdfMapper.onPageReady = function(info) {
          return console.log("Document page #" + info.index + " has become available. Should attach annotations.");
        };
      } else {
