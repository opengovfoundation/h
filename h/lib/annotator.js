...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.getTextPositionSelector = function(range) {
      var endInfo, endOffset, selector, startInfo, startOffset;
      if (this.pdfMode) {
        startInfo = this.pdfMapper.getInfoForNode(range.start);
        endInfo = this.pdfMapper.getInfoForNode(range.end);
    ...
    Annotator.prototype.findAnchorFromPositionSelector = function(target) {
      ...
      savedQuote = this.getQuoteForTarget(target);
      if (savedQuote != null) {
        content = this.pdfMode ? this.pdfMapper.getContentForCharRange(selector.start, selector.end) : this.domMapper.getContentForCharRange(selector.start, selector.end);
        currentQuote = this.normalizeString(content);
        if (currentQuote !== savedQuote) {
      ...
      mappings = this.pdfMode ? this.pdfMapper.getMappingsForCharRange(selector.start, selector.end) : this.domMapper.getMappingsForCharRange(selector.start, selector.end);
