...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype._onPageReady = function(info) {
      var anchors, browserRange, hl, mappings, range, selector, task, _k, _len2, _results;
      console.log("Document page #" + info.index + " has become available.");
      anchors = this.virtualAnchors[info.index];
      if (anchors == null) {
        return;
      }
      _results = [];
      for (_k = 0, _len2 = anchors.length; _k < _len2; _k++) {
        ...
        _results.push(console.log("Attached an annotation on page #" + info.index + ". (Quote: '" + task.anchor.quote + "')"));
      }
      return _results;
    };

    Annotator.prototype._addVirtualAnchor = function(pageIndex, anchor) {
      var _base;
      if ((_base = this.virtualAnchors)[pageIndex] == null) {
        _base[pageIndex] = [];
      }
      this.virtualAnchors[pageIndex].push(anchor);
    ...
    Annotator.prototype._setupMatching = function() {
      ...
      if (this.pdfMode) {
        ...
        this.pdfMapper.onPageReady = this._onPageReady;
        this.virtualAnchors = {};
      } else {
    ...
    Annotator.prototype.findAnchorFromRangeSelector = function(target, virtual) {
    ...
    Annotator.prototype.findAnchorFromPositionSelector = function(target, virtual) {
    ...
    Annotator.prototype.findAnchor = function(target, virtual) {
    ...
    Annotator.prototype.setupAnnotation = function(annotation) {
      var anchor, error, exception, index, normed, normedRanges, r, ranges, t, virtual, _k, _l, _len2, _len3, _m, _ref1, _ref2, _ref3, _ref4;
      ...
      for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
        t = _ref1[_k];
        try {
          _ref2 = this.findAnchor(t, virtual), anchor = _ref2.anchor, error = _ref2.error;
          if (error instanceof Range.RangeError) {
