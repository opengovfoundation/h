...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype._physicallyAnchorAnnotation = function(task) {
      ...
      task.done = true;
      return this.publish('annotationPhysicallyAnchored', task);
    };
    ...
    Annotator.prototype._setupMatching = function() {
      ...
      strategies = [
        {
          ...
          init: function() {
            return _this.docMapper.onPageReady = function(index) {
          ...
          init: function() {
            return _this.docMapper.setRootNode(_this.wrapper[0]);
          }
        }
      ];
      for (_k = 0, _len2 = strategies.length; _k < _len2; _k++) {
        ...
        if (s.mapper.applicable()) {
          ...
          this.docMapper = new s.mapper();
          this.docMatcher = new s.matcher(this.docMapper);
          this.virtualAnchoring = (_ref1 = s.mapper.requiresVirtualAnchoring) != null ? _ref1 : false;
